...
4. Add config knobs to `gateway/config.ts`
...
- Ship behind a `rate_limit.enabled` flag, default off
- Enable for 5% of traffic in staging for a day, then ramp production
